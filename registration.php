...
<div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" name="Index_no" id="Index_no"  placeholder="Index No(Students only)"/>
	</div>
</div>
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" name="Dept"  id="dept" placeholder="Deptartment(for HOD)"/>
	</div>
</div>
